...
public class MainActivity extends JFrame {
    ...
    private void setStokPanel() throws IOException{
        ...
        for(int index=0; index< _listItem.size();index++){
            ...
            _borderProduct[index] = BorderFactory.createTitledBorder(_listItem.get(index).get_pluName());
            ...
            _productPanel[index].setBorder(_borderProduct[index]);
            ...
            String _PATH = "D:\\Codingan\\Algoritma2\\Semester 2\\Session9-Shopper\\src\\img\\";
            ...
            _addButton[index].addActionListener(
                    e -> {
    ...
    private ArrayList<Shopper> getProductData() throws  IOException{
        ...
        String productResponse = ConnectURL.getResponseFromHttpUrl(sMe);
